...
insert into user_ (version, login, email, password_hash, role_id, active) values (0,'admin','admin@admin.pl','$2a$10$0Iu3Y/URm21pcr5uW5kLuenkeNSk1aOIiEeQzZ2cgSTTGCmDb3Q6e',1, true );
insert into user_ (version, login, email, password_hash, role_id, active) values (0,'user','izasobczyk1505@gmail.com','$2a$10$PyDUgMV3fi9bfZ/S4zBuCODOMrk5.INyOzCJLm04H30GoVm3tJJQe',2, true );
