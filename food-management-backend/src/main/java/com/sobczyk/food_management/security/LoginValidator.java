...
import com.sobczyk.food_management.exceptions.LoginValidatorException;
...
public class LoginValidator {
    ...
    public void checkBasicConditions(String login) {
        if (login.length() < length_min ||
            ...
            throw new LoginValidatorException("Login does not meet the basic conditions.","exception.incorrectLoginValidation");
        }
    }
